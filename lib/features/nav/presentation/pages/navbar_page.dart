...
class _NavbarPageState extends State<NavbarPage> {
  ...
  void didChangeDependencies() {
    ...
    // Initialize tab views here since we have access to full context
    if (_cachedTabs.isEmpty) {
      // Initialize all tabs at once for smoother experience
  ...
  Widget _buildTab(int index) {
    switch (index) {
      case 0:
        return BlocProvider(
          create: (_) => HomeCubit(GetIt.I<HomeUseCase>(), GetIt.I<HomeRepository>()),
